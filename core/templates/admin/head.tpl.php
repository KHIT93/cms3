...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link href="<?php print CORE_CSS_PATH;?>/jquery.gritter.css" rel="stylesheet" type="text/css">
	...
	<link href="<?php print CORE_JS_PATH;?>/jquery.select2/select2.css" rel="stylesheet" type="text/css" >
        ...
        <script src="<?php print CORE_JS_PATH;?>/bootstrap.min.js"></script>
        <script src="<?php print CORE_JS_PATH;?>/modernizr.min.js"></script>
    </head>