...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<link href="<?php print CORE_JS_PATH;?>/jquery.select2/select2.css" rel="stylesheet" type="text/css" >
        ...
        <link rel="stylesheet" type="text/css" href="<?php print CORE_JS_PATH;?>/jquery.codemirror/lib/codemirror.css">
        <link rel="stylesheet" type="text/css" href="<?php print CORE_JS_PATH;?>/jquery.codemirror/theme/ambiance.css">
