...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link href="<?php print CORE_INSTALLER_CSS_PATH;?>/bootstrap.min.css" rel="stylesheet" type="text/css">
        ...
        <link href="<?php print CORE_INSTALLER_CSS_PATH;?>/framework.css" rel="stylesheet" type="text/css">
        <link href="<?php print CORE_INSTALLER_CSS_PATH;?>/installer.css" rel="stylesheet" type="text/css">
    </head>